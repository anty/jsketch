...
#   BIGDATA_PID_DIR      The pid files are stored. Default is $BIGDATA_HOME/pids.
#                        Defined here. See bigdata-env.sh.
...
usage="Usage: bigdata-daemon.sh [--config <confdir>] [--copts <coptsfilepath>] (start|stop) <command> <args...>"
